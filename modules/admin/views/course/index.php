                                ...
                                <div class="card card-shadow mb-4">
                                    <div class="card-body">
                                        ...
                                        <table id="bs4-table" class="table table-bordered table-striped" cellspacing="0" width="100%">
                                            ...
                                            <tbody>
                                                <?php $count=1;foreach($course_list as $list):?>
                                                <tr>
                                                    ...
                                                    <td><div class="mytoggle">
                                                            <label class="switch">
                                                              <input type="checkbox" <?php if($list['status']== '1'){echo "checked";}?> onchange="checkStatus(this, '<?= $list['id']; ?>');" id="switch-<?= $count; ?>">
    ...
    function checkStatus(obj, id) {
        ...
        if (id) {
            $.ajax({
                ...
                type: 'post',
                data: 'method=checkStatus&dataId=' + id + '&action=' + status +'&type=2',
