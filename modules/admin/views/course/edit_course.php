                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row titleeventimage">
                                    ...
                                    <div class="col-sm-5 file-upload">
                                        <input type="text" class="form-control" placeholder="File Name" id="file-name" value="<?= $course['video'] ?>"/>
                                        <label for="upload" class="file-upload__label">Upload Video</label>
                                        <input id="upload" class="file-upload__input" type="file" name="video-upload" accept="video/*" onchange="set_value();">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-4 control-label">Course Type : </label>
                                    <div class="col-sm-5">
                                        <input type="text" class="form-control" placeholder="Course Type" name="course_type" value="<?= $course['course_type'] ?>" required/>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-4 control-label">Rating : </label>
                                    <div class="col-sm-5">
                                        <input type="number" min="1" max="5" class="form-control" placeholder="Rating" name="rating" value="<?= $course['rating'] ?>" required/>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-4 control-label">Course Name : </label>
                                    <div class="col-sm-5">
                                        <input type="text" class="form-control" placeholder="Course Name" name="course_name" value="<?= $course['course_name'] ?>" required/>
                                    </div>
                                </div>
                                <div class="form-group row titleeventimage">
                                    <label class="col-sm-4 control-label">Upload Image : </label>
                                    <div class="col-sm-5 file-upload">
                                        <img id="blah1" src="<?php if($course['image']==""){echo base_url('assets/images/logo/dummy.jpg');}else{echo $course['image']; } ?>" alt="your image" />
                                        <label for="upload1" class="file-upload__label">Upload Thumbnail</label>
                                        <input id="upload1" class="file-upload__input" type="file" name="file-upload" onchange="readURL(this, 1);" accept="image/*">
                                    </div>
                                </div>
                            </div>
                        </div>
