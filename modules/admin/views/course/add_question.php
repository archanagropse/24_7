                        ...
                        <div class="card card-shadow mb-4 qbody">
                            <div class="card-body question1">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-5">
                                        <textarea class="form-control question" required rows="3" name="question[]" data-id="1"></textarea>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-4 control-label">Option 1 : </label>
                                    <div class="col-sm-5">
                                        <input type="text" class="form-control" required placeholder="Option 1" name="option_1[]"/>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-4 control-label">Option 2 : </label>
                                    <div class="col-sm-5">
                                        <input type="text" class="form-control" required placeholder="Option 2" name="option_2[]"/>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-4 control-label">Option 3 : </label>
                                    <div class="col-sm-5">
                                        <input type="text" class="form-control" required placeholder="Option 3" name="option_3[]"/>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-4 control-label">Option 4 : </label>
                                    <div class="col-sm-5">
                                        <input type="text" class="form-control" required placeholder="Option 4" name="option_4[]"/>
                                    </div>
                                </div>
                                <div class="form-group row">
...
<script>
    function addmorequestion() {
        ...
        html +="<textarea class='form-control question' rows='3' name='question[]' data-id='"+count+"'></textarea>";
        html +="</div>";
        html +="</div>";
        html +="<div class='form-group row'>";
        html +="<label class='col-sm-4 control-label'>Option 1 : </label>";
        html +="<div class='col-sm-5'>";
        html +="<input type='text' class='form-control' placeholder='Option 1' name='option_1[]'/>";
        html +="</div>";
        html +="</div>";
        html +="<div class='form-group row'>";
        html +="<label class='col-sm-4 control-label'>Option 2 : </label>";
        html +="<div class='col-sm-5'>";
        html +="<input type='text' class='form-control' placeholder='Option 2' name='option_2[]'/>";
        html +="</div>";
        html +="</div>";
        html +="<div class='form-group row'>";
        html +="<label class='col-sm-4 control-label'>Option 3 : </label>";
        html +="<div class='col-sm-5'>";
        html +="<input type='text' class='form-control' placeholder='Option 3' name='option_3[]'/>";
        html +="</div>";
        html +="</div>";
        html +="<div class='form-group row'>";
        html +="<label class='col-sm-4 control-label'>Option 4 : </label>";
        html +="<div class='col-sm-5'>";
        html +="<input type='text' class='form-control' placeholder='Option 4' name='option_4[]'/>";
        html +="</div>";
        html +="</div>";
        html +="<div class='form-group row'>";
