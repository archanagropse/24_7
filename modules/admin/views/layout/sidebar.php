      ...
      <div class="side_bar scroll_auto">
        ...
        <ul id="dc_accordion" class="sidebar-menu tree">
         ...
         <li class="menu_sub">
			...
			<ul class="down_menu">
				<li><a href="<?php echo base_url('Request/new-request');?>">New Request</a></li>
				<li><a href="<?php echo base_url('Request/cancel-request');?>">Cancelled Request</a></li>
			</ul>
		</li>
		<li class="menu_sub">
			<a href="#">
			...
			<ul class="down_menu">
				<li><a href="<?php echo base_url('Request/assigned-request');?>">Assigned Shift</a></li>
				<li><a href="<?php echo base_url('Request/accepted-request');?>">Accepted Shift</a></li>
				<li><a href="<?php echo base_url('Request/ongoing-request');?>">Ongoing Shift</a></li>
				<li><a href="<?php echo base_url('Request/complete-request');?>">Complete Shift</a></li>
				<li><a href="<?php echo base_url('Request/cancelled-request');?>">Cancelled Shift</a></li>
			</ul>
		</li>
