            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <div class="detailbox">
                        ...
                        <h4><a href="<?=base_url('Admin/provider-detail/'.$request_info['provider_id']);?>"><?php echo $request_info['provider_name']; ?> <i class="fa fa-eye"></i></a></h4>
			...
			<div class="row">
				<div class="col-md-4">
					<div class="detailbox">
						...
						<h4><a href="<?=base_url('Admin/caregiver-detail/'.$request_info['user_id']);?>"><?php echo $request_info['user_name']; ?> <i class="fa fa-eye"></i></a></h4>
					</div>
				</div>
				<div class="col-md-4">
					<div class="detailbox">
						<h3>Assigned Date</h3>
						<h4><?= $request_info['assigned_date'] ?></h4>
					</div>
				</div>
				<div class="col-md-4">
					<div class="detailbox">
						<h3>Assigned Date</h3>
						<h4><?= $request_info['accepted_date'] ?></h4>
					</div>
				</div>
				<?php
				if($request_info['status']==5){
					?>
					<div class="col-md-4">
						<div class="detailbox">
							<h3>Job Start Date</h3>
							<h4><?= $request_info['job_start_date'] ?></h4>
						</div>
					</div>
					<div class="col-md-4">
						<div class="detailbox">
							<h3>Job Start Location</h3>
							<h4><?= $request_info['job_start_location'] ?></h4>
						</div>
					</div>
					<?php
					...
					<div class="col-md-4">
							<div class="detailbox">
								<h3>Job Complete Date</h3>
								<h4><?= $request_info['job_complete_date'] ?></h4>
							</div>
						</div>
						<div class="col-md-4">
							<div class="detailbox">
								<h3>Job Complete Location</h3>
								<h4><?= $request_info['job_complete_location'] ?></h4>
							</div>
						</div>
